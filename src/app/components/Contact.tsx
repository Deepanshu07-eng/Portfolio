...
export function Contact() {
  ...
  const links = [
    {
      label: "Resume",
      value: "Deepaanshu_Data_Analyst_resume.pdf",
      href: resumeUrl,
      icon: <FileDown size={14} />,
      download: "Deepaanshu_Data_Analyst_resume.pdf",
    },
    {
      label: "Email",
      value: "d2004gautam@gmail.com",
      href: "mailto:d2004gautam@gmail.com",
      icon: <Mail size={14} />,
    },
    {
      label: "GitHub",
      value: "github.com/Deepanshu07-eng",
      href: "https://github.com/Deepanshu07-eng",
      icon: <Github size={14} />,
    },
    {
      label: "LinkedIn",
      value: "https://www.linkedin.com/in/deepanshu-gautam-d15d7/",
      href: "https://www.linkedin.com/in/deepanshu-gautam-d15d7/",
